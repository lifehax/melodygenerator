...
WideRandomIntervalMelodyGenerator::WideRandomIntervalMelodyGenerator(Type * type, MIDITrack * target) : SongGenerator(type, target) {
	this->trackWork = new TrackBoard(target);
}

void WideRandomIntervalMelodyGenerator::generateTrack() {
	...
	MelodyParameter<int> * bassLowerNoteLimitParam = bassParams->setParam<int>(MelodyParameterType::LOWER_NOTE_LIMIT, 25);
	MelodyParameter<int> * bassUpperNoteLimitParam = bassParams->setParam<int>(MelodyParameterType::UPPER_NOTE_LIMIT, 40);
